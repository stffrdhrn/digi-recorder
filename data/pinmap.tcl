...
# SPI3 - DAC output only
#  MOSI ->  GPIO_03     (Pin  6, JP1 header)
#  SCK  ->  GPIO_01     (Pin  4, JP1 header)
#  SS   ->  GPIO_00     (Pin  2, JP1 header)
#
set_location_assignment PIN_A3 -to spi3_mosi_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to spi3_mosi_o
set_location_assignment PIN_C3 -to spi3_sck_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to spi3_sck_o
set_location_assignment PIN_D3 -to spi3_ss_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to spi3_ss_o

# PWM1 - PWM DAC output
#   PWMO  -> GPIO_07   (Pin 10, JP1 header)
set_location_assignment PIN_B5 -to pwm1_o
set_instance_assignment -name IO_STANDARD "3.3-V LVTTL" -to pwm1_o
